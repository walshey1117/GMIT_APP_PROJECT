...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myWebView.loadUrl("http://rhineroversfc.com/");
        ...
        mDrawerList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(position == 0)
                {
                    ...
                    Intent myIntent = new Intent(MainActivity.this, GMIT_tour.class);
                ...
                if(position == 4)
                {
                    Intent myIntent =  new Intent(MainActivity.this, moodle.class);
                    startActivityForResult(myIntent, 0);
                }
                if(position == 5)
                {
                    Intent myIntent =  new Intent(MainActivity.this, GMIT_lIBRARY.class);
                    startActivityForResult(myIntent, 0);
                }
                if(position == 6)
                {
                    Intent myIntent =  new Intent(MainActivity.this, Student_Portal.class);
                    startActivityForResult(myIntent, 0);
                }
                if(position == 7)
                {

                    Intent myIntent =  new Intent(MainActivity.this, Time_Table.class);
                    startActivityForResult(myIntent, 0);
                }
                if(position == 8)
                {

                    Intent myIntent =  new Intent(MainActivity.this, Bus_Time_Table.class);
                    startActivityForResult(myIntent, 0);
                }
            }
        });
